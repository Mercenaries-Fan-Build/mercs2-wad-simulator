//! `mercs2_anim` — Animation runtime — controllers, IK, ragdoll, FaceFX (wavelet sampling already solved).
//!
//! **Silo 8** (`docs/modernization/reimplementation_parallelization_plan.md` §3).
//! **Scoreboard row(s):** 20.
//! **Code map:** `docs/reverse_engineer/animation_code_map.md`.
//! **Owned Lua namespace(s):** `Human.*` (animation).
//! Hard edge: ragdoll consumes `mercs2_core::PhysicsQuery` (silo 7) — via the trait, not the impl.
//!
