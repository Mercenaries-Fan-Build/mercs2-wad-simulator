-- Stand-in for the shipped localization module `Subtitles_08_RME_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_08_RME_C` shadows this file the moment it
