-- Stand-in for the shipped localization module `Subtitles_02_AOB_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_02_AOB_C` shadows this file the moment it
