-- Stand-in for the shipped localization module `Subtitles_13_AVI_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_13_AVI_C` shadows this file the moment it
