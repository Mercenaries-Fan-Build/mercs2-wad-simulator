-- Stand-in for the shipped localization module `Subtitles_06_YNH_M`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_06_YNH_M` shadows this file the moment it
