-- Stand-in for the shipped localization module `Subtitles_11_SR1_S`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_11_SR1_S` shadows this file the moment it
