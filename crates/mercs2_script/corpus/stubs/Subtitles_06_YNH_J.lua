-- Stand-in for the shipped localization module `Subtitles_06_YNH_J`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_06_YNH_J` shadows this file the moment it
