-- Stand-in for the shipped localization module `Subtitles_10_BRV_J`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_10_BRV_J` shadows this file the moment it
