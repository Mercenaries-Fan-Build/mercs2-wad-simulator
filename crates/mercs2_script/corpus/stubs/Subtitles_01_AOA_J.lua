-- Stand-in for the shipped localization module `Subtitles_01_AOA_J`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_01_AOA_J` shadows this file the moment it
