-- Stand-in for the shipped localization module `Subtitles_14_CVI_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_14_CVI_C` shadows this file the moment it
