-- Stand-in for the shipped localization module `Subtitles_07_RHE_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_07_RHE_C` shadows this file the moment it
