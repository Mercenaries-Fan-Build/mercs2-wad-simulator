-- Stand-in for the shipped localization module `Subtitles_13_AVI_M`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_13_AVI_M` shadows this file the moment it
