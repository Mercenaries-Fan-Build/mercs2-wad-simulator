-- Stand-in for the shipped localization module `Subtitles_15_ACK_J`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_15_ACK_J` shadows this file the moment it
