-- Stand-in for the shipped localization module `Subtitles_14_CVI_M`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_14_CVI_M` shadows this file the moment it
