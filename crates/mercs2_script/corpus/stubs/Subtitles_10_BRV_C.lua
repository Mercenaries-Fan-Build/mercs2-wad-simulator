-- Stand-in for the shipped localization module `Subtitles_10_BRV_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_10_BRV_C` shadows this file the moment it
