-- Stand-in for the shipped localization module `Subtitles_07_RHE_M`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_07_RHE_M` shadows this file the moment it
