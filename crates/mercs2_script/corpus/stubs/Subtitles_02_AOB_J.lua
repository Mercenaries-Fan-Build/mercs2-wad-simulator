-- Stand-in for the shipped localization module `Subtitles_02_AOB_J`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_02_AOB_J` shadows this file the moment it
