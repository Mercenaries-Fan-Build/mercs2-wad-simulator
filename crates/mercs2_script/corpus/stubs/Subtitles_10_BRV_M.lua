-- Stand-in for the shipped localization module `Subtitles_10_BRV_M`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_10_BRV_M` shadows this file the moment it
