-- Stand-in for the shipped localization module `Subtitles_12_CAR_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_12_CAR_C` shadows this file the moment it
