-- Stand-in for the shipped localization module `Subtitles_02_AOB_M`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_02_AOB_M` shadows this file the moment it
