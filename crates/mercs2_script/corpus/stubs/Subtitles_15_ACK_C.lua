-- Stand-in for the shipped localization module `Subtitles_15_ACK_C`.
--
...
--
-- This root is searched AFTER the corpus, so a real `Subtitles_15_ACK_C` shadows this file the moment it
