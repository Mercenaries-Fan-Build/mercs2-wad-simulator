//! `mercs2_vehicle` — Vehicle actor family + custom raycast drive model, plus camera modes.
//!
//! **Silo 9** (`docs/modernization/reimplementation_parallelization_plan.md` §3).
//! **Scoreboard row(s):** 25, 19.
//! **Code map:** `docs/reverse_engineer/vehicle_code_map.md (+ camera_code_map.md, road_graph_ai_driving_code_map.md)`.
//! **Owned Lua namespace(s):** `Vehicle`, `Camera`.
//! Hard edge: raycast-wheel + camera collision consume `mercs2_core::PhysicsQuery` (silo 7).
//!
