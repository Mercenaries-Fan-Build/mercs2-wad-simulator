...
pub const TAG_REGISTRY: &[TagInfo] = &[
    ...
    TagInfo { fourcc: *b"TREE", handler_va: 0x0045f629, subsystem: UcfxAsset, verify: Validated, note: "ECS tree/hierarchy array @0x45f629: count×0x34 records (overflow-guarded). Validated: body % 0x34 == 0" },
