//! `mercs2_audio` — Audio backend, mixer, dual-deck music FSM, banks, 3D positional.
//!
//! **Silo 14** (`docs/modernization/reimplementation_parallelization_plan.md` §3).
//! **Scoreboard row(s):** 21.
//! **Code map:** `docs/reverse_engineer/audio_code_map.md`.
//! **Owned Lua namespace(s):** `Sound`, `VO`.
//!
